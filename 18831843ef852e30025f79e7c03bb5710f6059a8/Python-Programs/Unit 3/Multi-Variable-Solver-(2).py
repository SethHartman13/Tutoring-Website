...
class main:
    def start():
        ...
        valid_input = "n"
        while valid_input == "n":
            user_input = input("\nDoes Ay include a trig function? ").lower()
            user_input, valid_input = input_management.input_validator(user_input)
        ...
        valid_input = "n"
        while valid_input == "n":
            user_input = input("\nDoes Bx include a trig function? ").lower()
            user_input, valid_input = input_management.input_validator(user_input)
        ...
        valid_input = "n"
        while valid_input == "n":
            user_input = input("\nDoes By include a trig function? ").lower()
            user_input, valid_input = input_management.input_validator(user_input)
        By = input_management.trig_determiner(user_input)
        print()
    
        Xcon = float(input("\nEnter value of the x-axis constant. "))
        print()
        Ycon = float(input("\nEnter value of the y-axis constant. "))
        print()
